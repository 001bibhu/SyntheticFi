...
1. Search the docs using the **AI search** on the [home page](/)
2. Check [Troubleshooting](/core/troubleshooting) for common fixes
3. Review [FAQ](/core/faq) for quick answers
